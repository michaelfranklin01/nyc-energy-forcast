...
def load_and_clean_data():
    # Example paths to raw data
    path_energy_2021 = os.path.join('data', 'raw', 'energy_2021.csv')
    path_buildings = os.path.join('data', 'raw', 'building_footprints.shp')
    ...
    # Save processed data
    out_path_2021 = os.path.join('data', 'processed', 'merged_2021.geojson')
